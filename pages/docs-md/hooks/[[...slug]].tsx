...
const matchesThisRoute = (doc: DocMd) => doc._raw.sourceFileDir.startsWith('docs-md/hooks');
const compareAsJSON = (a: unknown, b: unknown) => JSON.stringify(a) === JSON.stringify(b);
const buildSlug = (doc: DocMd) => doc._raw.flattenedPath.replace('docs-md/hooks/', '').split('/');
